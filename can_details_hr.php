        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="candidate_hr.html"><i class="fa fa-plus-square"></i>Candidate Details <i class="fa fa-fw fa-caret-down"></i></a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                         ...
                         <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index_hr.html">Dashboard</a>
                            </li>
                            <li class="active">
						...
						if(isset($_GET['can']))
						{
							...
							if(mysql_num_rows($can_result)>0)
							{
								...
								while($row=mysql_fetch_array($can_result))
								{
									...
									echo "<tr>";
									echo "<td> Result of 10th :</td>";						
									echo "<td>".$result_10."</td>";
									echo "</tr>";
									
									echo "<tr>";
									echo "<td> Result of 12th :</td>";						
