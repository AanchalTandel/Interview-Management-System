    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_hr.html">HR</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index_hr.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>		
                    </li>
                     <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                         ...
                         <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index_hr.php">Dashboard</a>
                            </li>
                            <li class="active">
				...
				<div class="row">
					...
					<a href="sorting.php">Sort by marks</a>
...
<?php
						$list= mysql_query("SELECT can_id,marks,can_username FROM candidate order by marks desc");
						if(mysql_num_rows($list) > 0) 
						{ // output data of each row
							echo "<table class='table' width='150'>";
							echo "<tr><th>Candidate Name</th><th>Marks</th></tr>";
