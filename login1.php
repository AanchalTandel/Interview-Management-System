...
<body style="margin:50px;padding:0px;">
                    ...
                    <div class="panel panel-primary">
						...
						<form  method="POST"  enctype="multipart/form-data">
							...
							<div class="row">
									...
									<a href="adm_reg(a).php">New Registration </a>
									</div>
									</form>
                                </div>
	...
	if(isset($_POST['submit']))
	{
		...
		{
			echo "<script type='text/javascript'>alert('incorrect login id and password');document.getElementById('UserName').focus();</script>";		
		}
	}	
	?>
